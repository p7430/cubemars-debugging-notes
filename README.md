...
2. Connect them to your controller. I'm using a Jetson Orin Nano, so I attached my CAN Bus Transceiver to the Jetson Orin Nano, and then added a terminating resistor connecting CAN High and CAN Low. If you're unfamiliar with how CAN Bus actually works, I highly recommend watching some videos to understand the setup and why you need a terminating resistor. Double check with a multimeter that once you add the terminating resistor across CAN High and CAN Low it reads 60 Ω.
